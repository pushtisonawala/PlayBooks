export const taskTypes = {
  ...
  REDIS_GET_INFO: "REDIS GET_INFO",
  REDIS_GET_SLOWLOG: "REDIS GET_SLOWLOG",
  REDIS_RUN_COMMAND: "REDIS RUN_COMMAND",
  ...
  BIGQUERY_QUERY: "BIG_QUERY QUERY_TABLE",
  ARGOCD_FETCH_DEPLOYMENT_INFO: "ARGOCD FETCH_DEPLOYMENT_INFO",
  ARGOCD_ROLLBACK_APPLICATION: "ARGOCD ROLLBACK_APPLICATION",
  ARGOCD_GET_APPLICATION_HEALTH: "ARGOCD GET_APPLICATION_HEALTH",
  JIRA_CREATE_TICKET: "JIRA_CLOUD CREATE_TICKET",
  JIRA_GET_USERS: "JIRA_CLOUD GET_USERS",
  JIRA_ASSIGN_TICKET: "JIRA_CLOUD ASSIGN_TICKET",
  JIRA_GET_TICKET: "JIRA_CLOUD GET_TICKET",
  JIRA_SEARCH_TICKETS: "JIRA_CLOUD SEARCH_TICKETS",
};
