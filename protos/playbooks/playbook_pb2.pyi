...
import protos.playbooks.source_task_definitions.redis_task_pb2
...
class PlaybookTask(google.protobuf.message.Message):
    ...
    @property
    def redis(self) -> protos.playbooks.source_task_definitions.redis_task_pb2.Redis: ...
    def __init__(
        self,
        *,
        id: google.protobuf.wrappers_pb2.UInt64Value | None = ...,
...
class PlaybookStepResultCondition(google.protobuf.message.Message):
    ...
    class RuleSet(google.protobuf.message.Message):
        ...
        VARIABLE_RULES_FIELD_NUMBER: builtins.int
